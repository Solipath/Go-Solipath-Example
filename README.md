# Solipath Go example project
This is a quick showcase of using Solipath for a go project
...
If you have an existing go project, all you should need to do is copy the solipath, solipath.bat (once it is there), and the solipath.json files over to your project.
